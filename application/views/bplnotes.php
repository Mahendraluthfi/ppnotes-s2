...
<body>
    ...
    <div class="row">
        <div class="col-xs-2">Actual Pilot</div>
        <div class="col-xs-8 text-danger"><?php echo date('d M Y', strtotime($pl->date_pl)) ?></div>
    </div>
    <div class="row">
...
<div class="font-content">
    ...
    <ul class="list-group">
        <li class="list-group-item">
            ...
            <div class="row">
                ...
                <div class="col-xs-3 text-success">Action Complete By</div>
                <div class="col-xs-3 text-success">Comments</div>
            </div>
            <div class="row">
                <div class="col-xs-1"><?php if($pl->pl_mp1_1 == "on"){echo '<b>V</b>';} ?></div>
                <div class="col-xs-3">Contract/red seal approval/availability</div>
                <div class="col-xs-3 text-primary"><?php echo $pl->pl_mp1_5 ?></div>
                <div class="col-xs-3 text-primary"><?php echo $pl->pl_mp1_6 ?></div>
            </div>
            <div class="row">
                <div class="col-xs-1"><?php if($pl->pl_mp1_2 == "on"){echo '<b>V</b>';} ?></div>
                <div class="col-xs-3">Size set</div>
                <div class="col-xs-3 text-primary"><?php echo $pl->pl_mp1_7 ?></div>
                <div class="col-xs-3 text-primary"><?php echo $pl->pl_mp1_8 ?></div>
            </div>
            <div class="row">
                <div class="col-xs-1"><?php if($pl->pl_mp1_3 == "on"){echo '<b>V</b>';} ?></div>
                <div class="col-xs-3">Construction Sheet</div>
                <div class="col-xs-3 text-primary"><?php echo $pl->pl_mp1_9 ?></div>
                <div class="col-xs-3 text-primary"><?php echo $pl->pl_mp1_10 ?></div>
            </div>
            <div class="row">
                <div class="col-xs-1"><?php if($pl->pl_mp1_4 == "on"){echo '<b>V</b>';} ?></div>
                <div class="col-xs-3">"How to measure" Sheet</div>
                <div class="col-xs-3 text-primary"><?php echo $pl->pl_mp1_11 ?></div>
                <div class="col-xs-3 text-primary"><?php echo $pl->pl_mp1_12 ?></div>
            </div>
        </li>     
        <li class="list-group-item">
            ...
            <div class="row">
                <div class="col-xs-1">If Yes,</div>
                <div class="col-xs-2">Questions --</div>
                <div class="col-xs-8 text-primary"><?php echo $pl->pl_mp2_2 ?></div>
            </div>
            <div class="row">
                <div class="col-xs-1">&nbsp;</div>
                <div class="col-xs-2">Amandement --</div>
                <div class="col-xs-8 text-primary"><?php echo $pl->pl_mp2_3 ?></div>
            </div>
        </li>   
        <li class="list-group-item">    
            ...
            <div class="row">
                ...
                <div class="col-xs-8 text-primary"><?php echo $pl->pl_mp3_2 ?></div>
            </div>
            <div class="row">
                <div class="col-xs-1">If Not,</div>
                <div class="col-xs-2">Action- -</div>
                <div class="col-xs-8 text-primary"><?php echo $pl->pl_mp3_3 ?></div>
            </div>
            <div class="row">
                <div class="col-xs-1">&nbsp;</div>
                <div class="col-xs-2">Action By --</div>
                <div class="col-xs-8 text-primary"><?php echo $pl->pl_mp3_4 ?></div>
            </div>            
        </li>
        <li class="list-group-item">
        ...
        <li class="list-group-item">
            ...
            <div class="row">
                <div class="col-xs-1">If Not,</div>
                <div class="col-xs-10">Reason --<span class="text-primary"><?php echo $pl->pl_mp7_2 ?></span></div>
            </div>
            <div class="row">
                <div class="col-xs-1">&nbsp;</div>
                <div class="col-xs-10">The date it would be sent --<span class="text-primary"><?php echo $pl->pl_mp7_3 ?></span></div>
            </div>
            <div class="row">
                <div class="col-xs-1">&nbsp;</div>
                <div class="col-xs-10">Action By --<span class="text-primary"><?php echo $pl->pl_mp7_4 ?></span></div>
            </div>
        </li>
        <li class="list-group-item">
            ...
            <div class="row">
                <div class="col-xs-1">If Not,</div>
                <div class="col-xs-10">The documents that has not been included --<span class="text-primary"><?php echo $pl->pl_mp8_2 ?></span></div>
            </div>
            <div class="row">
                <div class="col-xs-1">&nbsp;</div>
                <div class="col-xs-10">The date it would be completed --<span class="text-primary"><?php echo $pl->pl_mp8_3 ?></span></div>
            </div>
            <div class="row">
                <div class="col-xs-1">&nbsp;</div>
                <div class="col-xs-10">Action By --<span class="text-primary"><?php echo $pl->pl_mp8_4 ?></span></div>
            </div>
        </li>
        <li class="list-group-item">
    ...
    <ul class="list-group">
        <li class="list-group-item">
             <div class="row">
                <div class="col-xs-1">If Not,</div>
                <div class="col-xs-10">Action --<span class="text-primary"><?php echo $pl->pl_mp9_8 ?></span></div>
            </div>
            <div class="row">
                <div class="col-xs-1">&nbsp;</div>
                <div class="col-xs-10">Time --<span class="text-primary"><?php echo $pl->pl_mp9_9 ?></span></div>
            </div>
            <div class="row">
                <div class="col-xs-1">&nbsp;</div>
                <div class="col-xs-10">Action By --<span class="text-primary"><?php echo $pl->pl_mp9_10 ?></span></div>
            </div>
        </li>
        <li class="list-group-item">
    ...
    <ul class="list-group">
        <li class="list-group-item">
            ...
            <table class="table table-condensed">
                ...
                <tbody>
                    <tr>
                        <td><?php if($pl->pl_me1_1 == "on"){echo '<b>V</b>';} ?></td>
                    ...
                    <tr>
                        <td><?php if($pl->pl_me1_2 == "on"){echo '<b>V</b>';} ?></td>
                    ...
                    <tr>
                        <td><?php if($pl->pl_me1_3 == "on"){echo '<b>V</b>';} ?></td>
                    ...
                    <tr>
                        <td><?php if($pl->pl_me1_4 == "on"){echo '<b>V</b>';} ?></td>
        ...
        <li class="list-group-item">
            ...
            <div class="row">
                <div class="col-xs-1">If Yes,</div>
                <div class="col-xs-2">Questions --</div>
                <div class="col-xs-8 text-primary"><?php echo $pl->pl_me2_2 ?></div>
            </div>
            <div class="row">
                <div class="col-xs-1">&nbsp;</div>
                <div class="col-xs-2">Amandement --</div>
                <div class="col-xs-8 text-primary"><?php echo $pl->pl_me2_3 ?></div>
            </div>            
        </li>
        <li class="list-group-item">
            Fabric Technical Specifications & Compositions <br>
            <div class="row">
                <div class="col-xs-5">Part(s)</div>
                <div class="col-xs-7 text-primary"><?php echo $pl->pl_me3_1 ?></div>
            </div>
            <div class="row">
                <div class="col-xs-5">Fabric Quality ( Ref # )</div>
                <div class="col-xs-7 text-primary"><?php echo $pl->pl_me3_2 ?></div>
            </div>
            <div class="row">
                <div class="col-xs-5">Knitting method / woven</div>
                <div class="col-xs-7 text-primary"><?php echo $pl->pl_me3_3 ?></div>
            </div>
            <div class="row">
                <div class="col-xs-5">Composition</div>
                <div class="col-xs-7 text-primary"><?php echo $pl->pl_me3_5 ?></div>
            </div>
            <div class="row">
                <div class="col-xs-5">Weight gms/m2</div>
                <div class="col-xs-7 text-primary"><?php echo $pl->pl_me3_5 ?></div>
            </div>
            <div class="row">
                <div class="col-xs-5">Test method & /Result</div>
                <div class="col-xs-7 text-primary"><?php echo $pl->pl_me3_6 ?></div>
            </div>
            <div class="row">
                <div class="col-xs-5">Stability ( Length / widthwise )</div>
                <div class="col-xs-7 text-primary"><?php echo $pl->pl_me3_7 ?></div>
            </div>
            <div class="row">
                <div class="col-xs-5">Composition details of wash care lable insturctlions</div>
                <div class="col-xs-7 text-primary"><?php echo $pl->pl_me3_8 ?></div>
            </div>
    ...
    <ul class="list-group">
        <li class="list-group-item">
            ...
            <table class="table table-condensed">
                ...
                <tbody>
                    <tr>
                        <td><?php if($pl->pl_ma1_1 == "on"){echo '<b>V</b>';} ?></td>
                    ...
                    <tr>
                        <td><?php if($pl->pl_ma1_2 == "on"){echo '<b>V</b>';} ?></td>
                    ...
                    <tr>
                        <td><?php if($pl->pl_ma1_3 == "on"){echo '<b>V</b>';} ?></td>
                        <td>Attachemnts</td>
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">
            ...
            <table border="1" style="border-collapse: collapse; width: 100%; border-color: #cccccc;" class="text-center">
              <tr>
    ...
    <ul class="list-group">
        ...
        <table class="table table-condensed">
            ...
            <li class="list-group-item">
                Pilot Cut
                <div class="row">
                    <div class="col-xs-2">Cut Date</div>
                    <div class="col-xs-3 text-primary"><?php echo $pl2->pl_cu2_1 ?></div>
                    <div class="col-xs-2">No. of Gmts Cut</div>
                    <div class="col-xs-3 text-primary"><?php echo $pl2->pl_cu2_2 ?></div>
                </div>
                <div class="row">
                    <div class="col-xs-2">Docket No.</div>
                    <div class="col-xs-3 text-primary"><?php echo $pl2->pl_cu2_3 ?></div>
                    <div class="col-xs-2">Marker No.</div>
                    <div class="col-xs-3 text-primary"><?php echo $pl2->pl_cu2_4 ?></div>
                </div>
                <div class="row">
                    <div class="col-xs-2">Ply depth</div>
                    <div class="col-xs-3 text-primary"><?php echo $pl2->pl_cu2_5 ?></div>
                    <div class="col-xs-2">Relaxatioan</div>
                    <div class="col-xs-3 text-primary"><?php echo $pl2->pl_cu2_6 ?></div>
                </div>
            </li>
            <li class="list-group-item">
    ...
    <ul class="list-group">
        ...
        <table class="table table-condensed">
            ...
            <tbody>
                <tr>
                    <td><?php if($pl2->pl_mo1_1 == "on"){echo '<b>V</b>';} ?></td>
    ...
    <ul class="list-group">
        <li class="list-group-item">
            ...
            <div class="row">
                <div class="col-xs-1 text-center">If Not</div>
                <div class="col-xs-10">
    ...
    <ul class="list-group">
        <li class="list-group-item">
            ...
            <div class="row">
                <div class="col-xs-1 text-center">If Yes</div>
                <div class="col-xs-10">
    ...
    <ul class="list-group">
        ...
        <table class="table table-condensed">
            ...
            <tbody>
                <tr>
                    <td><?php if($pl2->pl_pc1_1 == "on"){echo '<b>V</b>';} ?></td>
                ...
                <tr>
                    <td><?php if($pl2->pl_pc1_2 == "on"){echo '<b>V</b>';} ?></td>
                ...
                <tr>
                    <td><?php if($pl2->pl_pc1_3 == "on"){echo '<b>V</b>';} ?></td>
                ...
                <tr>
                    <td><?php if($pl2->pl_pc1_4 == "on"){echo '<b>V</b>';} ?></td>
    ...
    <ul class="list-group">
        ...
        <table border="1" style="border-collapse: collapse; width: 100%; border-color: #cccccc;" class="text-center">      
            <tr>
                <td colspan="2" rowspan="2"><b>Are the followings correct according to the spec ?</b></td>
