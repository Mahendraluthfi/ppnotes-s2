                                    ...
                                    <td>
                                        ...
                                        if ($data->final == "0") {                                            
                                            if ($respons->employee_respon == "USER") { ?>
                                                <a href="<?php echo base_url('scheduling_stf/form/'.base64_encode($data->scheduling_id)) ?>" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Submit Form PP">&nbsp;<i class="la la-newspaper-o"></i></a>
                                       <?php } 
                                        ...
                                        <?php }
                                            if ($respons->employee_respon == "USER" && $this->session->userdata('department') == "Technical") { ?>
                                                <a href="<?php echo base_url('scheduling_stf/form_pdra/'.base64_encode($data->scheduling_id)) ?>" class="btn btn-secondary btn-sm" data-toggle="tooltip" data-placement="top" title="PPA Document of DRA & PDRA">&nbsp;<i class="la la-file-archive-o"></i></a>    
