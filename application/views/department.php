...
<div class="row">
    <div class="page-header">
        <div class="d-flex align-items-center">
            <h2 class="page-header-title">Master Department</h2>
            <div>
                        ...
                        <tbody>
                            <?php $no = 1; foreach ($get as $data) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-info mr-1 mb-2 btn-sm" onclick="edit('<?php echo $data->department_id ?>')"><i class="la la-edit"></i>Edit</button>
                                        <button type="button" class="btn btn-danger mr-1 mb-2 btn-sm" onclick="f_delete('<?php echo $data->department_id ?>')"><i class="la la-trash"></i>Delete</button>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
...
<script>
    ...
    function edit(id){
          ...
          $.ajax({
            url : "<?php echo site_url('index.php/department/get')?>/" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function save() {
        ...
        var url;
        if(save_method == 'add'){
          url = "<?php echo site_url('index.php/department/save')?>";          
      }else{          
          url = "<?php echo site_url('index.php/department/edit/')?>" + gid;         
      }
    ...
    function dlt(id) {
        $.ajax({
            url : "<?php echo site_url('index.php/department/delete')?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {           
