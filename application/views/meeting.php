                    ...
                    <table id="sorting-table" class="table mb-0">
                        ...
                        <tbody>
                            <?php $no = 1; foreach ($get as $data) { ?>
                                ...
                                <td><?php if($data->final == "0"){echo "Process";}else{echo "Finalized";}?></td>    
				<td>
                                        ...
                                        <button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip" onclick="att('<?php echo $data->scheduling_id ?>')" data-placement="top" title="Meeting Attendees">&nbsp;<i class="la la-users"></i></button>
                                        <a href="<?php echo base_url('meeting/sign/'.$data->scheduling_id) ?>" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Sign Meeting">&nbsp;<i class="la la-caret-square-o-right"></i></a>
                                        <a href="<?php echo base_url('meeting/participants/'.$data->scheduling_id) ?>" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Add Attendees">&nbsp;<i class="la la-user-plus"></i></a>
                                        <?php if ($data->final == "0"): ?>                                            
                                        <a href="<?php echo base_url('meeting/finalize/'.$data->scheduling_id) ?>" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Finalization" onclick="return confirm('Are You Sure ?')">&nbsp;<i class="la la-check-circle"></i></a>
                                        <?php endif ?>
                                    </td>
                                </tr>
                            <?php } ?>
