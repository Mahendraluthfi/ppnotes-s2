...
<html lang="en">
    <head>
        ...
        <title>PP Notes System - Login</title>
                    ...
                    <div class="elisyam-bg background-03">
                        ...
                        <div class="authentication-col-content-2 mx-auto text-center">
                            <div class="logo-centered">
                                <a href="#">
                                    <img src="<?php echo base_url() ?>assets/img/main-logo.png" alt="logo">
                                </a>
                            </div>
                            <!-- <h1>MAS SUMBIRI</h1> -->
...
<!--                                     <div class="col text-right">
        ...
        <!-- End Page Snippets -->
        <script>
            // $('body').on('click', '#btn-error', function (e) {
            //      new Noty({
            //         type: 'error',
            //         layout: 'topRight',
