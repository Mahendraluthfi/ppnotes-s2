...
<body>
    ...
    <div class="row">
        <div class="col-2">Actual PP</div>
        <div class="col-8 text-danger"><?php echo date('d M Y', strtotime($pp->date_pp)) ?></div>
    </div>
    <div class="row">
    ...
    <div class="font-content">        
        ...
        <ul class="list-group">
            ...
            <li class="list-group-item">Are completed approved trim cards for all colours issued to relevant depts. ( FT,RM,CU,PR & QA ) ? <span class="text-primary"><?php echo $pp->pp_m2_1 ?></span>
                <div class="row">
                    <div class="col-2">If Not, Reason</div>
                    <div class="col-8 text-primary"><?php echo $pp->pp_m2_2 ?></div>
                </div>
                <div class="row">
                    <div class="col-2">Action By</div>
                    <div class="col-4 text-primary"><?php echo $pp->pp_m2_3 ?></div>
                    <div class="col-2">Issuing Date</div>
                    <div class="col-4 text-primary"><?php if($pp->pp_m2_4 !== '0000-00-00'){echo $pp->pp_m2_4;} ?></div>
                </div>            
            </li>                                
            <li class="list-group-item">Is there any discrepancies between Trim Card & Approved Standard? <span class="text-primary"><?php echo $pp->pp_m3_1 ?></span>
                <div class="row">
                    <div class="col-2">If Not, Action taken</div>
                    <div class="col-8 text-primary"><?php echo $pp->pp_m3_2 ?></div>
                </div>
            ...
            <li class="list-group-item">Are following documents available & distributed ?<br>
                ...
                <div class="row">
                    <div class="col-2">If Not,Issuing Date</div>
                    <div class="col-4 text-primary"><?php echo $pp->pp_m4_4 ?></div>
                    <div class="col-2">Action By</div>
                    <div class="col-4 text-primary"><?php echo $pp->pp_m4_7; ?></div>
                </div>            
                BOM -- <span class="text-primary"><?php echo $pp->pp_m4_2 ?></span>                
                <div class="row">
                    <div class="col-2">If Not,Issuing Date</div>
                    <div class="col-4 text-primary"><?php echo $pp->pp_m4_5 ?></div>
                    <div class="col-2">Action By</div>
                    <div class="col-4 text-primary"><?php echo $pp->pp_m4_8; ?></div>
                </div>            
                LOF -- <span class="text-primary"><?php echo $pp->pp_m4_3 ?></span>
                <div class="row">
                    <div class="col-2">If Not,Issuing Date</div>
                    <div class="col-4 text-primary"><?php echo $pp->pp_m4_6 ?></div>
                    <div class="col-2">Action By</div>
                    <div class="col-4 text-primary"><?php echo $pp->pp_m4_9; ?></div>
                </div>            
            </li>                        
            ...
            <li class="list-group-item">Can delivery dates be met as per MPO/CPO/SLC delivery schedule? <span class="text-primary"><?php echo $pp->pp_m5_1 ?></span><br>
                ...
                <div class="row">
                    <div class="col-3">If Not,Issuing Date</div>
                    <div class="col-3 text-primary"><?php echo $pp->pp_m5_3 ?></div>
                    <div class="col-2">Action By</div>
                    <div class="col-3 text-primary"><?php echo $pp->pp_m5_4 ?></div>
                </div>            
            </li>            
        ...
        <ul class="list-group">
            <li class="list-group-item">Are Fabric Pre-Production Notes available ? <span class="text-primary"><?php echo $pp->pp_f1_1 ?></span><br>
                ...
                <div class="row">
                    <div class="col-2">If Not,Action</div>
                    <div class="col-4 text-primary"><?php echo $pp->pp_f1_3 ?></div>
                    <div class="col-2">Action By</div>
                    <div class="col-4 text-primary"><?php echo $pp->pp_f1_4 ?></div>
                </div>                            
            ...
            <li class="list-group-item">Are Fabric Test Reports available ? <span class="text-primary"><?php echo $pp->pp_f2_1 ?></span><br>
                ...
                <div class="row">
                    <div class="col-2">If Not,Action</div>
                    <div class="col-4 text-primary"><?php echo $pp->pp_f2_3 ?></div>
                    <div class="col-2">Action By</div>
                    <div class="col-4 text-primary"><?php echo $pp->pp_f2_4 ?></div>
                </div>                            
            </li>                
            <li class="list-group-item">Fabric Details</li>
            <li class="list-group-item">
                <div class="row">
                     <div class="col-2 text-success">Fabric</div>
                     <div class="col-3"></div>
                     <div class="col-2 text-success">Lace</div>
                 </div> 
                 <div class="row">
                     <div class="col-2">Supplier</div>
                     <div class="col-3 text-primary"><?php echo $pp->pp_f3_1 ?></div>
                     <div class="col-2">Supplier</div>
                     <div class="col-4 text-primary"><?php echo $pp->pp_f3_6 ?></div>
                 </div>
                 <div class="row">
                     <div class="col-2">Type</div>
                     <div class="col-3 text-primary"><?php echo $pp->pp_f3_2 ?></div>
                     <div class="col-2">Type</div>
                     <div class="col-4 text-primary"><?php echo $pp->pp_f3_7 ?></div>
                 </div>
                 <div class="row">
                     <div class="col-2">Composition</div>
                     <div class="col-3 text-primary"><?php echo $pp->pp_f3_3 ?></div>
                     <div class="col-2">Composition</div>
                     <div class="col-4 text-primary"><?php echo $pp->pp_f3_8 ?></div>
                 </div>
                 <div class="row">
                     <div class="col-2">Fabric Rate</div>
                     <div class="col-3 text-primary"><?php echo $pp->pp_f3_4 ?></div>
                     <div class="col-2">Fabric Rate</div>
                     <div class="col-4 text-primary"><?php echo $pp->pp_f3_9 ?></div>
                 </div>
                 <div class="row">
                     <div class="col-2">Defect</div>
                     <div class="col-3 text-primary"><?php echo $pp->pp_f3_5 ?></div>
                     <div class="col-2">Defect</div>
                     <div class="col-4 text-primary"><?php echo $pp->pp_f3_10 ?></div>
                 </div>
            </li>                    
            ...
            <li class="list-group-item">Stripe / Check fabric : <span class="text-primary"><?php echo $pp->pp_f5_1 ?></span><br>
                Bowing percentage
                <div class="row">
                     <div class="col-2">In fabric form</div>
                     <div class="col-1 text-primary"><?php echo $pp->pp_f5_2 ?></div>
                     <div class="col-3">What percentage is approved in panel / garment form</div>
                     <div class="col-1 text-primary"><?php echo $pp->pp_f5_3 ?></div>
                 </div>
            </li>
            <li class="list-group-item">Lace / Stripe / Check fabric Repeat variations : <span class="text-primary"><?php echo $pp->pp_f6_1 ?></span><br>
                As Per Spec
                <div class="row">
                     <div class="col-2">Repeat Length</div>
                     <div class="col-3 text-primary"><?php echo $pp->pp_f6_3 ?></div>
                     <div class="col-3">Tolerance</div>
                     <div class="col-3 text-primary"><?php echo $pp->pp_f6_4 ?></div>
                 </div>
                 <div class="row">
                     <div class="col-2">Repeat variation in fabric form</div>
                     <div class="col-3 text-primary"><?php echo $pp->pp_f6_5 ?></div>
                     <div class="col-3">What percentage is approved in panel & garment form</div>
                     <div class="col-3 text-primary"><?php echo $pp->pp_f6_6 ?></div>
                 </div>
            </li>            
            <li class="list-group-item">
            ...
            <li class="list-group-item">
                ...
                <div class="row">
                    <div class="col-3">If Yes,Approved by (Supplier):</div>
                    <div class="col-2 text-primary"><?php echo $pp->pp_f8_3 ?></div>
                    <div class="col-2">If Not,Issuing Date</div>
                    <div class="col-4 text-primary"><?php echo $pp->pp_f8_4 ?></div>
                </div>                
                <span class="text-success">HS / Fussing / Laminating Conditions</span><br>
                <div class="row">
                    <div class="col-3">Setting Temperature</div>
                    <div class="col-2 text-primary"><?php echo $pp->pp_f8_5 ?></div>
                    <div class="col-3">Bond strength</div>
                    <div class="col-3 text-primary"><?php echo $pp->pp_f8_6 ?></div>
                </div>                
                <div class="row">
                    <div class="col-3">Glue line Temperature</div>
                    <div class="col-2 text-primary"><?php echo $pp->pp_f8_7 ?></div>
                    <div class="col-3">Feel off method</div>
                    <div class="col-3 text-primary"><?php echo $pp->pp_f8_8 ?></div>
                </div>                
                <div class="row">
                    <div class="col-3">Time</div>
                    <div class="col-2 text-primary"><?php echo $pp->pp_f8_9 ?></div>
                    <div class="col-3">Lamination method</div>
                    <div class="col-3 text-primary"><?php if($pp->pp_f8_10 == "1"){echo "Cool";}elseif ($pp->pp_f8_10 == "2") {echo "Hot";} ?></div>
                </div>                
                <div class="row">
                    <div class="col-3">Pressure</div>
                    <div class="col-2 text-primary"><?php echo $pp->pp_f8_11 ?></div>
                    <div class="col-3">Lamination done at</div>
                    <div class="col-3 text-primary"><?php if($pp->pp_f8_12 == "1"){echo "Sri Lanka";}elseif ($pp->pp_f8_12 == "2") {echo "Offshow";} ?></div>
                </div>                
            </li>
            <li class="list-group-item">
        ...
        <div class="page-break">
            &nbsp;
            <div class="float-right" style="margin-right: 10px">4</div>
        </div>
            <ul class="list-group">
                <li class="list-group-item">Is there any colour shade variation in all colours -- <span class="text-primary"><?php echo $pp->pp_f10_1 ?></span><br>
                    ...
                    <div class="row">
                        <div class="col-1 text-center"><?php if($pp->pp_f10_3 == "on"){echo '<b>V</b>';} ?></div>
                        <div class="col-10">Batch to Batch shade - B -to-B separations & all shades are within the approved shade band</div>
                    </div>
                    <div class="row">
                        <div class="col-1 text-center"><?php if($pp->pp_f10_4 == "on"){echo '<b>V</b>';} ?></div>
                        <div class="col-10">Within the Roll shade - Use close-marker & within the garment shade is approved</div>
                    </div>
                    <div class="row">
                        <div class="col-1 text-center"><?php if($pp->pp_f10_5 == "on"){echo '<b>V</b>';} ?></div>
                        <div class="col-10">Rejecth fabric / Lace / Elastics</div>
                    </div>
                    <div class="row">
                        <div class="col-1 text-center"><?php if($pp->pp_f10_6 == "on"){echo '<b>V</b>';} ?></div>
                        <div class="col-10">Any other, Specify -- <span class="text-primary"><?php echo $pp->pp_f10_7 ?></span></div>
                    </div>
                </li>
                <li class="list-group-item">
                    ...
                    <div class="row">
                        ...
                        <div class="col-1">Lengthwise</div>
                        <div class="col-1 text-primary"><?php echo $pp->pp_f11_3 ?></div>
                        <div class="col-1">Widthwise</div>
                        <div class="col-1 text-primary"><?php echo $pp->pp_f11_4 ?></div>
                    </div>
                </li>
                <li class="list-group-item">
                    Fabric /Marker width
                    <div class="row">
                        <div class="col-1">Spec</div>
                        <div class="col-1 text-primary"><?php echo $pp->pp_f12_1 ?></div>
                        <div class="col-1">Usable</div>
                        <div class="col-1 text-primary"><?php echo $pp->pp_f12_2 ?></div>
                        <div class="col-1 text-primary"><?php echo $pp->pp_f12_3 ?></div>
                    </div>
                </li>
                <li class="list-group-item">
                    Special comments <br>
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item">Is approved Contract / Red / Green Seal available ? <span class="text-primary"><?php echo $pp->pp_ct2_1 ?></span><br>
                    <div class="row">
                        <div class="col-2">Apporved By</div>
                        <div class="col-2 text-primary"><?php echo $pp->pp_ct2_2 ?></div>
                        <div class="col-2">Date</div>
                        <div class="col-2 text-primary"><?php echo $pp->pp_ct2_3 ?></div>
                    </div>
                    <div class="row">
                        <div class="col-2">If Not, Action</div>
                        <div class="col-2 text-primary"><?php echo $pp->pp_ct2_4 ?></div>
                        <div class="col-2">Action By</div>
                        <div class="col-2 text-primary"><?php echo $pp->pp_ct2_5 ?></div>
                    </div>
                </li>
                <li class="list-group-item">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item">
                    ...
                    <div class="row">
                        <div class="col-2">If Not, Action</div>
                        <div class="col-2 text-primary"><?php echo $pp->pp_ct7_3 ?></div>
                        <div class="col-2">Action By</div>
                        <div class="col-2 text-primary"><?php echo $pp->pp_ct7_4 ?></div>
                    </div>
                </li>
            </ul>
            <div class="page-break">
                &nbsp;
                <div class="float-right" style="margin-right: 10px">5</div>
            </div>
            <ul class="list-group">                
                <li class="list-group-item">
            ...
            <ul class="list-group">
                <li class="list-group-item">What are the matching requirements ?
                    <div class="row">
                        <div class="col-5">Stripes & checks</div>
                        <div class="col-6">Lace   MACHING LACE (ATT TO THE PP METING SHEET)</div>
                    </div>
                    <div class="row">
                        <div class="col-1"><?php if($pp->pp_ct12_1 == "on"){echo '<b>V</b>';} ?></div>
                        <div class="col-4">100 % side seam matching</div>
                        <div class="col-1"><?php if($pp->pp_ct12_2 == "on"){echo '<b>V</b>';} ?></div>
                        <div class="col-4">Exact matching point &amp; Colour specific Yes / No</div>
                    </div>
                    <div class="row">
                        <div class="col-1"><?php if($pp->pp_ct12_3 == "on"){echo '<b>V</b>';} ?></div>
                        <div class="col-4">Waist or Hem straight</div>
                        <div class="col-1"><?php if($pp->pp_ct12_5 == "on"){echo '<b>V</b>';} ?></div>
                        <div class="col-4">Choice of placement points ( indicate on the diagram )</div>
                    </div>
                    <div class="row">
                        <div class="col-1"><?php if($pp->pp_ct12_6 == "on"){echo '<b>V</b>';} ?></div>
                        <div class="col-4">Other -- <span class="text-primary"><?php echo $pp->pp_ct12_4; ?></span></div>
                        <div class="col-1"><?php if($pp->pp_ct12_7 == "on"){echo '<b>V</b>';} ?></div>
                        <div class="col-4">Exclusive placement points ( indicate on the diagram )</div>
                    </div>
                    <div class="row">
                        <div class="col-1"></div>
                        <div class="col-4"></div>
                        <div class="col-1"><?php if($pp->pp_ct12_8 == "on"){echo '<b>V</b>';} ?></div>
                        <div class="col-4">Free priority point</div>
                    </div>
                    <div class="row">
                        <div class="col-1"></div>
                        <div class="col-4"></div>
                        <div class="col-1"><?php if($pp->pp_ct12_9== "on"){echo '<b>V</b>';} ?></div>
                        <div class="col-4">Length only</div>
                    </div>
                    <div class="row">
                        <div class="col-1"></div>
                        <div class="col-4"></div>
                        <div class="col-1"><?php if($pp->pp_ct12_10 == "on"){echo '<b>V</b>';} ?></div>
                        <div class="col-4">Other -- <span class="text-primary"><?php echo $pp->pp_ct12_11; ?></span></div>
                    </div>                    
                </li>                          
            </ul>
            <div class="page-break">
                &nbsp;
                <div class="float-right" style="margin-right: 10px">6</div>
            </div>    
            <ul class="list-group">
                <li class="list-group-item">
            ...
            <ul class="list-group">
                <li class="list-group-item">
                    ...
                    <div class="row">
                        ...
                        <div class="col-9">Placements ( excluding seam allowance )</div>
                    </div>
                    <div class="row">
                        <div class="col-2"><span class="text-primary"><?php echo $pp->pp_ct13_1; ?></span></div>
                        <div class="col-9">(<span class="text-primary"><?php echo $pp->pp_ct13_2; ?></span>) cm / inch down / up from (<span class="text-primary"><?php echo $pp->pp_ct13_3; ?></span>) to the top / bottom of the (<span class="text-primary"><?php echo $pp->pp_ct13_4; ?></span>)</div>
                    </div>
                    <div class="row">
                        <div class="col-2"></div>
                        <div class="col-9">(<span class="text-primary"><?php echo $pp->pp_ct13_5; ?></span>)  cm / inch from left / right seam edge / center line to the left / right of the (<span class="text-primary"><?php echo $pp->pp_ct13_6; ?></span>)</div>
                    </div>
                    <div class="row">
                        <div class="col-2"></div>
                        <div class="col-9">Seam allowance (<span class="text-primary"><?php echo $pp->pp_ct13_7; ?></span>) cm / inches</div>
                    </div>                       
                    <div class="row">
                        <div class="col-2"><span class="text-primary"><?php echo $pp->pp_ct13_8; ?></span></div>
                        <div class="col-9">(<span class="text-primary"><?php echo $pp->pp_ct13_9; ?></span>) cm / inch down / up from (<span class="text-primary"><?php echo $pp->pp_ct13_10; ?></span>) to the top / bottom of the (<span class="text-primary"><?php echo $pp->pp_ct13_11; ?></span>)</div>
                    </div>
                    <div class="row">
                        <div class="col-2"></div>
                        <div class="col-9">(<span class="text-primary"><?php echo $pp->pp_ct13_12; ?></span>)  cm / inch from left / right seam edge / center line to the left / right of the (<span class="text-primary"><?php echo $pp->pp_ct13_13; ?></span>)</div>
                    </div>
                    <div class="row">
                        <div class="col-2"></div>
                        <div class="col-9">Seam allowance (<span class="text-primary"><?php echo $pp->pp_ct13_14; ?></span>) cm / inches</div>
                    </div>                 
                </li>                
                <li class="list-group-item">
                    Garment way <br>
                ...
                <li class="list-group-item">
                    ...
                    <div class="row">
                        <div class="col-3 text-success">Direction</div>
                        <div class="col-3 text-success">Garment part(s)</div>
                    </div>
                    <div class="row">
                        <div class="col-3">Parallel to selvage</div>
                        <div class="col-3"><span class="text-primary"><?php echo $pp->pp_ct15_2; ?></span></div>
                    </div>
                    <div class="row">
                        <div class="col-3">Perpendicular to Selvage</div>
                        <div class="col-3"><span class="text-primary"><?php echo $pp->pp_ct15_3; ?></span></div>
                    </div>                
                </li>
            </ul>        
           <!--  <h4>Moulding (If Any)</h4>
            ...
            <ul class="list-group">
                <li class="list-group-item">
                    Specify
                    <div class="row">
                        <div class="col-2">Marker Length</div>
                        <div class="col-1 text-primary"><?php echo $pp->pp_c1_1; ?></div>
                        <div class="col-2">Play Height</div>
                        <div class="col-1 text-primary"><?php echo $pp->pp_c1_2; ?></div>
                        <div class="col-2">Comments</div>
                        <div class="col-3 text-primary"><?php echo $pp->pp_c1_3; ?></div>
                    </div>
                </li>
                <li class="list-group-item">
                    ...
                    <div class="row">
                        ...
                        <div class="col-5 text-primary"><?php echo $pp->pp_c2_1; ?></div>                        
                    </div>
                    <div class="row">
                        <div class="col-2">Lace--</div>
                        <div class="col-5 text-primary"><?php echo $pp->pp_c2_2; ?></div>                        
                    </div>
                    <div class="row">
                        <div class="col-2">Foam--</div>
                        <div class="col-5 text-primary"><?php echo $pp->pp_c2_3; ?></div>                        
                    </div>
                </li>
                <li class="list-group-item">
                    Special Comments -- 
