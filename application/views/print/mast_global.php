...
<style>
	@font-face {
        font-family: "calibri";
        src: url("<?php echo base_url() ?>assets/css/pdf/calibri.ttf");
    }
...
<body>
	<table width="100%">
		<tr>
			<td width="15%" valign="top"><img src="<?php echo base_url() ?>assets/img/mast_global.png" alt="" height="70"></td>
			<td>
      ...
      <span style="font-size: 14px">BRA MOLDING SPECIFICATION QUALITY / METHOD / CONDITIONS</span>
    	<table width="100%" border="1" style="border-collapse: collapse;" cellpadding="2" cellspacing="0">      
            <tr>
              ...
              <tr>
                <td colspan="2" style="vertical-align: top;"><img src="<?php echo base_url() ?>assets/img/mastinfo.png" height="150" alt=""></td>
              </tr>
        </table>   -->                              
</body>
</html>
